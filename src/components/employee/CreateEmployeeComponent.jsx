...
class CreateEmployeeComponent extends Component {
    ...
    saveEmployee = (e) => {
        e.preventDefault();
        let employee = {employeeId:this.state.employeeId,employeeName: this.state.employeeName, employeeEmail: this.state.employeeEmail, phoneNumber: this.state.phoneNumber, employeeRole: this.state.employeeRole};
    ...
    save(){
        this.props.history.push(`/CreateEmployee/{manager_id}`);
    }
    cancel(){
                        ...
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className = "card-body">
                                ...
                                <div className = "form-group">
                                        ...
                                        <input placeholder="Id" name="employeeId" className="form-control" 
